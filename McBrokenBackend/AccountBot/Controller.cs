...
namespace AccountBot
{
    ...
    {
        public static async Task<string> InitialJWT()
        {
            ...
            var request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri("https://us-prod.api.mcd.com/v1/security/auth/token"),
                Headers =
                {
        ...
        static async Task<string> RegisterAccount(string firstName, string lastName, int zip, string emailPrefix)
        {
            string deviceID = GetRandomHexNumber(16);
            ...
            {
                Method = HttpMethod.Post,
                RequestUri = new Uri("https://us-prod.api.mcd.com/exp/v1/customer/registration"),
                Headers =
                {
                    { "Host", "us-prod.api.mcd.com" },
        ...
        static Random random = new Random(784123908);
